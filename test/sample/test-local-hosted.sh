...
(cd src/AccelByte.PluginArch.Revocation.Demo.Server && dotnet run) & GRPC_SERVER_PID=$!
...
(cd src/AccelByte.PluginArch.Revocation.Demo.Client && dotnet run -- --grpc-target ${NGROK_URL#*://})